  ...
  return (
    <section className="space-y-5">
      <div className="space-y-3">
        <SectionHeading title="Services" icon={<ServiceIcon size={24} />} />
        <SectionSubHeading>Découvrez mes services professionnels</SectionSubHeading>
      </div>
      <Card className="space-y-4 p-6">
        ...
        <p className="text-neutral-600 dark:text-neutral-400">
          Contactez-moi pour discuter de vos projets et voir comment je peux vous aider à les réaliser.
        </p>
        <Button
